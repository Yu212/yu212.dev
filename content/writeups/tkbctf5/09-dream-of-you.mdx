...
`/read`にアクセスさせるためには`http://dream-of-you:5000`をURLとして指定する必要がありますが、これはlinkfyにはURLとして認識されないため、`https://redirectmeto.com/http://dream-of-you:5000`のようにしてリダイレクトを噛ませる必要があります。
